...
## 3. Digite «ACME Ltda» no campo «Nome»

Use a razão social completa, sem abreviações.
...
![Passo 5 — Pressione Enter](imagens/passo-05.png)

## 6. Selecione «Brasil» em «País»

![Passo 6 — Selecione «Brasil» em «País»](imagens/passo-06.png)

## 7. Marque «Aceito os termos»

![Passo 7 — Marque «Aceito os termos»](imagens/passo-07.png)

## Conferência no SAP GUI

## 8. Escolha o menu «Arquivo › Salvar»

![Passo 8 — Escolha o menu «Arquivo › Salvar»](imagens/passo-08.png)
